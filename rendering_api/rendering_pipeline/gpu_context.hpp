...
#endif
/// Forward declaration of GPUContext so we can return it in std::optional
class GPUContext;
...
#if NO_CL_ASSERT == 0
#define ASSERT_CL_OK(code) __assert_cl_ok(code)
#else
#define ASSERT_CL_OK(code) (void*)(nullptr)
#endif
